        ...
        그래서 굳이 쓸 필요는 없다. */}
          ...
          <div className='img-box3'>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(1)}>
              ...
              <label htmlFor='3'>
                <img className='service' src="./icon/service (3).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(2)}>
              ...
              <label htmlFor='4'>
                <img className='service' src="./icon/service (4).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(3)}>
              ...
              <label htmlFor='5'>
                <img className='service' src="./icon/service (5).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(4)}>
              ...
              <label htmlFor='6'>
                <img className='service' src="./icon/service (6).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(5)}>
              ...
              <label htmlFor='7'>
                <img className='service' src="./icon/service (7).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(6)}>
              ...
              <label htmlFor='8'>
                <img className='service' src="./icon/service (8).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(7)}>
              ...
              <label htmlFor='9'>
                <img className='service' src="./icon/service (9).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(8)}>
              ...
              <label htmlFor='10'>
                <img className='service' src="./icon/service (10).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(9)}>
              ...
              <label htmlFor='11'>
                <img className='service' src="./icon/service (11).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(10)}>
              ...
              <label htmlFor='12'>
                <img className='service' src="./icon/service (12).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(11)}>  
              ...
              <label htmlFor='13'>
                <img className='service' src="./icon/service (13).png" alt="" />
              </label>
            </div>  
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(12)}>  
              ...
              <label htmlFor='14'>
                <img className='service' src="./icon/service (14).png" alt="" />
              </label>
            </div> 
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(13)}> 
              ...
              <label htmlFor='15'>
                <img className='service' src="./icon/service (15).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(14)}>
              ...
              <label htmlFor='16'>
                <img className='service' src="./icon/service (16).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(15)}>
              ...
              <label htmlFor='17'>
                <img className='service' src="./icon/service (17).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(16)}> 
              ...
              <label htmlFor='18'>
                <img className='service' src="./icon/service (18).png" alt="" />
              </label>
            </div> 
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(17)}>
              ...
              <label htmlFor='19'>
                <img className='service' src="./icon/service (19).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(18)}>
              ...
              <label htmlFor='20'>
                <img className='service' src="./icon/service (20).png" alt="" />
              </label>
            </div>
            ...
            <div className='img-box4' onClick={() => handleImgBox4Click(19)}>
              ...
              <label htmlFor='21'>
                <img className='service' src="./icon/service (21).png" alt="" />
              </label>
            </div>
