  ...
  const NullMenu = () => {
    ...
    <div>
      <div className='wrapper'>
          ...
          <div className="menu-box1" style={style2}>
            <div style={style} className="menu-box2">
                <div className='img-box'>
                  <img className='menu-img' src="./icon/service (21).png" alt="" />
                </div>
                <div className='img-box'>
                  <img className='menu-img' src="./icon/service (2).png" alt="" />
                </div>
                <div className='img-box'>
                  <img className='menu-img' src="./icon/service (4).png" alt="" />
                </div>
                <div className='img-box'>
                  <img className='menu-img' src="./icon/service (3).png" alt="" />
                </div>
                <div className='img-box'>
                  <img className='menu-img' src="./icon/service (5).png" alt="" />
                </div>
                <div className='img-box'>
                  <img className='menu-img' src="./icon/service (21).png" alt="" />
                </div>
        ...
        <img className='arrow1' src="./icon/made-icon-left.png" alt="뒤로" />
        <img className='arrow2' src="./icon/made-icon-right.png" alt="앞으로" />
      </div>       
    </div>   
    )
  }
      ...
      <div className='wrapper'>
        <div className='menu-box'>
          <div className="menu-box1" style={style2}>
            ...
            <img key={i} className='menu-img' src={`./icon/service (${item}).png`} alt="" />
            ))}
            </div>
          </div> 
          <div className='setting'>
    ...
    return(
      <div>
        <div className='wrapper'>
          ...
          <img onClick={prevSlide} className='arrow1' src="./icon/made-icon-left.png" alt="뒤로" />
          <img onClick={nextSlide} className='arrow2' src="./icon/made-icon-right.png" alt="앞으로" />
        </div>       
      </div>   
      )  
    }  
